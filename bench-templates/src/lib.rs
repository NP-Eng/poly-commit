...
/// function that outputs a random multilinear polynomial. `rand_point` is a
/// function that outputs a random point in the domain of polynomial.
...
fn test_sponge<F: PrimeField>() -> Transcript {
