...
fn main() {
    ...
    for num_vars in (MIN_NUM_VARS..MAX_NUM_VARS).step_by(2) {
        println!(
            "\tnum_vars: {}, size: {} B",
            num_vars,
            commitment_size::<_, Hyrax<G1Affine381>>(num_vars)
        );
    }
    ...
    for num_vars in (MIN_NUM_VARS..MAX_NUM_VARS).step_by(2) {
        println!(
            "\tnum_vars: {}, size: {} B",
            num_vars,
            commitment_size::<_, Ligero<Fr381>>(num_vars)
        );
    }
    ...
    for num_vars in (MIN_NUM_VARS..MAX_NUM_VARS).step_by(2) {
        println!(
            "\tnum_vars: {}, size: {} B",
            num_vars,
            commitment_size::<_, Brakedown<Fr381>>(num_vars)
        );
    }
    ...
    for num_vars in (MIN_NUM_VARS..MAX_NUM_VARS).step_by(2) {
        println!(
            "\tnum_vars: {}, size: {} B",
            num_vars,
            commitment_size::<_, Hyrax<G1Affine254>>(num_vars)
        );
    }
    ...
    for num_vars in (MIN_NUM_VARS..MAX_NUM_VARS).step_by(2) {
        println!(
            "\tnum_vars: {}, size: {} B",
            num_vars,
            commitment_size::<_, Ligero<Fr254>>(num_vars)
        );
    }
    ...
    for num_vars in (MIN_NUM_VARS..MAX_NUM_VARS).step_by(2) {
        println!(
            "\tnum_vars: {}, size: {} B",
            num_vars,
            commitment_size::<_, Brakedown<Fr254>>(num_vars)
        );
    }
    ...
    for num_vars in (MIN_NUM_VARS..MAX_NUM_VARS).step_by(2) {
        println!(
            "\tnum_vars: {}, size: {} B",
            num_vars,
            proof_size::<_, Hyrax<G1Affine381>>(num_vars)
        );
    }
    ...
    for num_vars in (MIN_NUM_VARS..MAX_NUM_VARS).step_by(2) {
        println!(
            "\tnum_vars: {}, size: {} B",
            num_vars,
            proof_size::<_, Ligero<Fr381>>(num_vars)
        );
    }
    ...
    for num_vars in (MIN_NUM_VARS..MAX_NUM_VARS).step_by(2) {
        println!(
            "\tnum_vars: {}, size: {} B",
            num_vars,
            proof_size::<_, Brakedown<Fr381>>(num_vars)
        );
    }
    ...
    for num_vars in (MIN_NUM_VARS..MAX_NUM_VARS).step_by(2) {
        println!(
            "\tnum_vars: {}, size: {} B",
            num_vars,
            proof_size::<_, Ligero<Fr254>>(num_vars)
        );
    }
    ...
    for num_vars in (MIN_NUM_VARS..MAX_NUM_VARS).step_by(2) {
        println!(
            "\tnum_vars: {}, size: {} B",
            num_vars,
            proof_size::<_, Brakedown<Fr254>>(num_vars)
        );
    }
}
